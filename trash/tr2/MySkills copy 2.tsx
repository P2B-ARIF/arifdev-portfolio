...
// const MySkills = () => {
// 	return (
// 		<div className='min-h-screen max-h-[900px] max-w-7xl container mx-auto w-full text-white'>
// 			<div className='grid grid-cols-12 grid-rows-7 gap-4 h-full w-full'>
// 				{/* 1st rows */}
// 				{/* Location Map */}
// 				<div className='col-span-4 row-span-3 rounded-lg overflow-hidden  relative border border-gray-600 p-2 bg-slate-500/20 backdrop-blur-lg h-[300px] 2xl:h-[400px]'>
...
// 				{/* Typing Speed */}
// 				<div className='col-span-3 row-span-3 rounded-lg overflow-hidden relative border border-gray-600 p-2 bg-slate-500/20 backdrop-blur-lg h-[300px] 2xl:h-[400px]'>
...
// 				{/* Skills */}
// 				<div className='col-span-5 row-span-6 rounded-lg overflow-hidden relative border border-gray-600 p-2 bg-slate-500/20 backdrop-blur-lg h-[600px] 2xl:h-[800px]'>
// 					<div className='rounded-md overflow-hidden h-full bg-primary p-4'>
...
// 				{/* 2nd rows */}
// 				<div className='col-span-7 row-span-1 grid grid-cols-7 gap-3 h-[100px]'>
// 					{/* Social Media */}
